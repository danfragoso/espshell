...
static int say_hello(int argc, char **argv)
{
    ...
    ESP_LOGI(__func__, "Hello %s, nice to meet you!!!", join_args.helloer->sval[0]);
    join_args.helloer = NULL;
    return 0;
...
void register_hello()
{
    join_args.helloer = arg_str1(NULL, NULL, "<string>", "Someone to say hello");
